...
#[test]
fn test_depth_adversarial_hugepagevec_massive() -> Result<(), Box<dyn Error>> {
...
#[test]
fn test_depth_adversarial_mmapblock_zero() -> Result<(), Box<dyn Error>> {
...
#[test]
fn test_depth_adversarial_mmapblock_huge() -> Result<(), Box<dyn Error>> {
...
#[test]
fn test_depth_adversarial_mmapcorpus_empty() -> Result<(), Box<dyn Error>> {
...
#[test]
fn test_depth_adversarial_mmapcorpus_null_byte_path() -> Result<(), Box<dyn Error>> {
    let dir = tempfile::tempdir()?;
...
#[test]
fn test_depth_adversarial_readahead_overflow() -> Result<(), Box<dyn Error>> {
    let dir = tempfile::tempdir()?;
...
#[test]
fn test_depth_adversarial_binformat_invalid_magic() -> Result<(), Box<dyn Error>> {
...
#[test]
fn test_depth_adversarial_binformat_short_payload() -> Result<(), Box<dyn Error>> {
...
#[test]
fn test_depth_adversarial_hugepagevec_zero_sized() -> Result<(), Box<dyn Error>> {
...
#[test]
fn test_depth_adversarial_mmapblock_alternating_patterns() -> Result<(), Box<dyn Error>> {
